                                            ...
                                            <div class="d-flex pl-0">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="svg15 double-check"></div>
                                                        ...
                                                        <span
                                                            class="message-shortcut margin-auto text-muted fs-13 ml-1 mr-4">I'm looking forward to it</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex pl-0">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="svg15 double-check"></div>
                                                        ...
                                                        <span
                                                            class="message-shortcut margin-auto fw-400 fs-13 ml-1 mr-4">Hey Quan, If you are free now we can meet tonight ?</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="chat-item d-flex pl-3 pr-0 pt-3 pb-3">
                                            <div class="w-100">
                                                <div class="d-flex pl-0">
                                                    ...
                                                    <div>
                                                        <p class="margin-auto fw-400 text-dark-75">{{ $user->nom_user }} {{ $user->prenom_user }}</p>
                                                        <div class="d-flex flex-row mt-1">
                                                        <span>
                                                        <div class="svg15 double-check"></div>
                                                        </span>
                                                            <span
                                                                class="message-shortcut margin-auto text-muted fs-13 ml-1 mr-4">find it hard to believe you don't know</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="w-100 p-3">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        ...
                                        <div class="message-options">
                                            ...
                                            <div class="message-arrow"><i class="text-muted la la-angle-down fs-17"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pr-4">Oh hey, I didn’t see you there. Did you already get a
                                            table?</p>
                                        <div class="message-options">
                                    ...
                                    <div class="d-flex flex-row-reverse mb-2">
                                        <div class="right-chat-message fs-13 mb-2">
                                            <div class="d-flex flex-row">
                                                <div class="pr-2">Not much. Hey, how did your interview go? Wasn’t that
                                                    today?
                                                </div>
                                                <div class="pr-4"></div>
                                            </div>
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pr-4">Oh, yeah. I think it went well. I don’t know if I got
                                            the job yet, but they said they would call in a few days.</p>
                                        <div class="message-options">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pr-4">Thanks. I’m just happy that it’s over. I was really
                                            nervous about it.</p>
                                        <div class="message-options">
